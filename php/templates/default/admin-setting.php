...
<table cellpadding="5" cellspacing="8" border="0" width="100%" class="fs12">
    ...
    <tr>
        ...
        <td width="auto" align="left"><input type="text" class="sl w200" name="wb_key" value="',$options['wb_key'],'" /></td>
    </tr>
    <tr>
        <td width="120" align="right">App Secret</td>
        <td width="auto" align="left"><input type="text" class="sl w200" name="wb_secret" value="',$options['wb_secret'],'" /></td>
    </tr>
    <tr>
        <td width="120" align="right"></td>
        <td width="auto" align="left"><input type="submit" value=" 保 存 " name="submit" class="textbtn" /></td>
    ...
    <tr>
        ...
        <td width="auto" align="left"><input type="text" class="sl w200" name="qq_appid" value="',$options['qq_appid'],'" /></td>
    </tr>
    <tr>
        <td width="120" align="right">appkey</td>
        <td width="auto" align="left"><input type="text" class="sl w200" name="qq_appkey" value="',$options['qq_appkey'],'" /></td>
    </tr>
    <tr>
        <td width="120" align="right"></td>
        <td width="auto" align="left"><input type="submit" value=" 保 存 " name="submit" class="textbtn" /></td>
    ...
    <tr>
        ...
        <td width="auto" align="left"><textarea class="ml w450" name="analytics_code">',str_replace('\\', '', $options['analytics_code']),'</textarea> 示例： 直接粘贴google 或 百度统计代码</td>
    </tr>
    <tr>
        <td width="120" align="right">垃圾信息关键字<br/>一般是网址(默认留空)</td>
        <td width="auto" align="left"><textarea class="ml w450" name="spam_words">',$options['spam_words'],'</textarea> 网址格式"www.xxx.com"，用逗号分隔，当用户发布的信息包含某个垃圾关键字时会自动禁用该用户，请勿滥用！</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td width="auto" align="left"><textarea class="ml w450" name="ad_post_top">',str_replace('\\', '', $options['ad_post_top']),'</textarea> 示例： 直接粘贴google 或 百度广告代码</td>
    </tr>
    <tr>
        <td width="120" align="right">文章内容底部<br/>(默认留空)</td>
        <td width="auto" align="left"><textarea class="ml w450" name="ad_post_bot">',str_replace('\\', '', $options['ad_post_bot']),'</textarea> 示例： 直接粘贴google 或 百度广告代码</td>
    </tr>
    <tr>
        <td width="120" align="right">侧栏顶部<br/>(默认留空)</td>
        <td width="auto" align="left"><textarea class="ml w450" name="ad_sider_top">',str_replace('\\', '', $options['ad_sider_top']),'</textarea> 示例： 直接粘贴google 或 百度广告代码</td>
    </tr>
    <tr>
        <td width="120" align="right">手机浏览页面底部<br/>(默认留空)</td>
        <td width="auto" align="left"><textarea class="ml w450" name="ad_web_bot">',str_replace('\\', '', $options['ad_web_bot']),'</textarea> 示例： 直接粘贴google 或 百度广告代码</td>
    </tr>
    <tr>
        <td width="120" align="right"></td>
        <td width="auto" align="left"><input type="submit" value=" 保 存 " name="submit" class="textbtn" /></td>
    ...
    <tr>
        ...
        <td width="auto" align="left"><input type="text" class="sl w200" name="close_note" value="',$options['close_note'],'" /> 默认"数据调整中"，简单写明关闭原因</td>
    </tr>
    <tr>
